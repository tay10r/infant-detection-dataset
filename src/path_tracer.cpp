...
class renderer_impl final : public cradle::renderer
{
public:
  renderer_impl(const int w, const int h, const int seed)
  {
...
{
  renderer_impl r(cam.width, cam.height, seed);
...
{
  renderer_impl r(cam.width, cam.height, /*seed=*/0);
